 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Adjust| Ctrl | Alt  | Esc  |Lower |Space |Bksp  |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT(
  ...
  ADJUST,  KC_LCTL, KC_LALT, KC_ESC, LOWER,   KC_SPC,  KC_BSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+--------+------| |------+--------+------+------+------+------|
 * |CtlEsc|   A  |   R  |   S  |   T    |   G  | |   M  |   N    |   E  |   I  |   O  |Ctl-' |
 * |------+------+------+------+--------+------| |------+--------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   D    |   V  | |   K  |   H    |   ,  |   .  |   /  |Shift |
 * |------+------+------+------+--------+------| |------+--------+------+------+------+------|
 * |Adjust|   -  | GUI  | RAlt | Lower  |Space | | Bksp |Raise   | RAlt | Ent  |   =  |Adjust|
 * `-------------------------------------------' `-------------------------------------------'
 */
[_COLEMAK] = LAYOUT(
  KC_GRV,          KC_1,    KC_2,    KC_3,    KC_4,    KC_5,  /**/  KC_6,    KC_7,  KC_8,    KC_9,   KC_0,    KC_DEL,
  ...
  ADJUST,          KC_MINS, KC_LGUI, KC_LALT, LOWER,   KC_SPC,/**/  KC_BSPC, RAISE, KC_RALT, KC_ENT, KC_EQL,   ADJUST
),
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, KC_7,    KC_8,    KC_9,    _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
 ...
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Reset|RGB Tg|RGB Md|Hue Up|Hue Dn|Sat Up|Sat Dn|Val Up|Val Dn|      |PrnSc |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] =  LAYOUT(
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
  _______, RESET  , RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, _______, KC_PSCR,
