 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      | Sclk | Pause| PrSc |                    | PgUp | Home |  Up  | End  | Del  | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | GUI  |  Alt | Ctrl | Shift| CAPS |-------.    ,-------| PgDn | Left | Down | Rght | Ret  |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      | AltGr|      |      |      |-------|    |-------|      |      |      |      | Bspc |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      |      |      |      | /       /       \      \  |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX,  KC_SCLN, KC_PAUSE,  KC_PSCR,                      KC_PGUP, KC_HOME, KC_UP, KC_END,  KC_DEL,  KC_F12,
  XXXXXXX, KC_LGUI, KC_LALT,  KC_LCTL,  KC_LSFT,  KC_CAPS,                      KC_PGDN, KC_LEFT, KC_DOWN,   KC_RGHT, KC_ENT, _______,
