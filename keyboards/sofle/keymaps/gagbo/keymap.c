...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,          KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_MPLY, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
           KC_LGUI,        KC_LALT,  LT(_MEDIA, KC_ESC), LT(_NAV, KC_TAB), LT(_MOUSE, KC_SPC),  /**/  LT(_SYM, KC_ENT),  LT(_NUM, KC_BSPC), LT(_FUN, KC_DEL),       KC_RALT,       KC_RCTL
),
/*
 * COLEMAK
 * cf BuJo
...
[_COLEMAK] = LAYOUT(
  ...
  LCTL_T(KC_ESC),  HOME_CMK_A,   HOME_CMK_R,    HOME_CMK_S,    KC_T,          KC_G,                                          KC_M,     KC_N,          HOME_CMK_E,    HOME_CMK_I,     HOME_CMK_O, RCTL_T(KC_QUOT),
