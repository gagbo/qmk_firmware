...
[_COLEMAK] = LAYOUT(
  ...
  LCTL_T(KC_ESC),  HOME_CMK_A,   HOME_CMK_R,    HOME_CMK_S,    HOME_CMK_T,    KC_G,                        KC_M,     HOME_CMK_N,    HOME_CMK_E,    HOME_CMK_I,    HOME_CMK_O, RCTL_T(KC_ENT),
  KC_LSFT,         KC_Z,         KC_X,          KC_C,          KC_D,          KC_V,   KC_MUTE,    KC_MPLY, KC_K,     KC_H,          KC_COMM,       KC_DOT,        KC_SLSH,    KC_QUOT,
...
[_LOWER] = LAYOUT(
  ...
  KC_LALT, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_LPRN,                         KC_RPRN, KC_MINS, KC_UNDS, KC_EQL,  KC_PLUS, _______,
  KC_LCTL, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_LCBR,                         KC_RCBR, _______, _______, _______, _______, _______,
